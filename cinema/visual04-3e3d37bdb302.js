...
function mountLanding(){
  ...
  heroStop?.();heroStop=null; /* Cinema uses photographic artwork instead of hidden WebGL. */
...
function mountReveal(){
  ...
  revealStop?.();
  if(!REDUCED&&document.body.dataset.edition!=='detail-04')revealStop=startParticleMorph(reveal.querySelector('.v3-morph'),choices,code,accent);
